...
export const STR = {
  ...
  'app.sub': { zh: 'RFID Tag 產線流動 · 互動拖拉原型', en: 'RFID tag line flow · interactive prototype' },
  ...
  // ---- tank ----
  'tank.countdown': { zh: 'Countdown 用碼表倒數', en: 'Countdown timer' },
  ...
  'suffix.acidFull': { zh: '酸 Acid', en: 'Acid' },
  'suffix.pwFull': { zh: '超純水 Water', en: 'PW Water' },
  ...
  'legend.flow': {
    zh: '單向流程（不可回頭/跳站）：Signin → IQC → 清洗區 Tank（↔ 移出區）→ HPW；倒酸/PW 至 Tank',
    en: 'One-way (no back/skip): Signin → IQC → Tank (↔ Removal) → HPW; fill Acid/PW into Tank',
  },

  // ---- operator screen ----
  'op.total': { zh: '總時間', en: 'Total' },
  'op.placeReq': { zh: '請放入', en: 'Please place' },
  'op.abnormal': { zh: '異常 · 請取出', en: 'Abnormal — remove' },
  ...
  'op.bench': { zh: 'Soak Bench', en: 'Soak Bench' },
  'op.tank': { zh: 'Tank', en: 'Tank' },
  ...
  'mon.partsInTank': { zh: '槽內零件 · Parts in tank', en: 'Parts in tank' },
  'mon.records': { zh: '出槽紀錄 · Left-tank records', en: 'Left-tank records' },
  'mon.unit': { zh: ' 件', en: ' pcs' },
  'mon.recUnit': { zh: ' 筆', en: ' rec' },
  'mon.th.runcard': { zh: '流程卡 Runcard', en: 'Runcard' },
  'mon.th.pnsn': { zh: 'PN / SN', en: 'PN / SN' },
  'mon.th.req': { zh: '要求', en: 'Required' },
  'mon.th.remain': { zh: '剩餘', en: 'Remaining' },
  'mon.th.prog': { zh: '進度', en: 'Progress' },
  'mon.th.status': { zh: '狀態 Status', en: 'Status' },
  'mon.th.liquid': { zh: '液體', en: 'Liquid' },
  'mon.th.actual': { zh: '實際', en: 'Actual' },
  'mon.th.result': { zh: '結果 Result', en: 'Result' },
  'mon.th.outTime': { zh: '出槽時間', en: 'Out time' },
  'mon.st.soaking': { zh: '浸泡中 Soaking', en: 'Soaking' },
  'mon.st.abnormal': { zh: '異常 Abnormal', en: 'Abnormal' },
  'mon.st.done': { zh: '達標・可取出', en: 'Ready' },
  'mon.st.near': { zh: '即將達標 Near', en: 'Near' },
  'mon.res.abnormal': { zh: '異常 NG', en: 'Abnormal NG' },
  'mon.res.pass': { zh: 'PASS 達標', en: 'PASS' },
  'mon.res.rinse': { zh: 'PW 完成', en: 'PW done' },
  'mon.noPart': { zh: '本槽目前沒有零件 · No part in tank', en: 'No part in tank' },
  'mon.noRec': { zh: '尚無零件離槽 · No records yet', en: 'No records yet' },
  'mon.foot': { zh: 'RFID Smart Station · 範例介面 demo — 倒數時間已加速以便展示', en: 'RFID Smart Station · demo — countdown accelerated for display' },
}
